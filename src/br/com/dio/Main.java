...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("1 - Inicicar um novo Jogo");
    ...
    private static void removeNumber() {
        ...
        System.out.println("Informe a coluna em que o número será retirado");
        var col = runUntilGetValidNumber(0 ,8);
        System.out.println("Informe a linha em que o número será retirado");
        var row = runUntilGetValidNumber(0 ,8);
